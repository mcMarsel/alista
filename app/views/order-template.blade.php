...
<table style="border: 1px solid white;  border-collapse: collapse; width: 100%;">
    <tr style="border: 1px solid white;  border-collapse: collapse; ">
        ...
        <td style="text-align: right; width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">
            Номер:
        </td>
...
<div class="table-container">
    <table style="width: 100%; border: 1px solid white;  border-collapse: collapse; ">
        ...
        <tr>
            ...
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px;">
                р/с 2600718904
            </td>
        </tr>
        <tr>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px;">
                49033, м. Дніпропетровськ
            </td>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px;">
                ПАТ «ПУМБ», м. Дніпропетровськ
            </td>
        </tr>
        <tr>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px;">
                вул. Героїв Сталінграда,147
            </td>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px; font-weight: bold;">
                МФО 334851
            </td>
        </tr>
        <tr>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px; font-weight: bold;">
                Податковий код: 002186104027, Свідоцтво: 100335408
            </td>
            <td style="align-content: center; border: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px;">
                Код ОКПО 00218615
            </td>
    ...
    <table style="width: 100%;">
        <thead>
        <tr>
            <td style="width: 20%; border-bottom: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px; font-weight: bold;">
                Підприємство
            </td>
        ...
        <tbody>
        <tr>
            <td style="width: 20%; border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px;">
                Адреса
            </td>
            ...
            <td style="width: 20%; border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px;">
                72 1
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            <td style="width: 20%; border-top: 1px solid white; border-collapse: collapse; text-align: right; font-size: 10px;">
                Телефон:
            </td>
            <td style="width: 60%; border-top: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px;">{{-- $CompContact --}}</td>
            <td style="width: 20%; border-top: 1px solid white; border-collapse: collapse; text-align: left; font-size: 10px;">
                0
            </td>
        </tr>
        </tfoot>
    ...
    <table style="border: 1px solid white;  border-collapse: collapse; width: 100%;">
        <tr style="border: 1px solid white;  border-collapse: collapse; ">
            <td style="width: 20%; text-align: left; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">
                Кількість: {{ $TQty }}</td>
            <td style="width: 65%; text-align: right; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">
                Сума без ПДВ
            </td>
