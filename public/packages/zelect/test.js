describe('zelect', function () {
    ...
    describe('Loader', function () {
        ...
        it('clears list on search term change', function () {
            setup('empty')
            $('#select').zelect({
                throttle: 0, loader: function (term, page, callback) {
    ...
    describe('Customization', function () {
        ...
        it('noResults', function () {
            setup('with-two-options')
            $('#select').zelect({
                throttle: 0, noResults: function (term) {
                    return 'POW[' + term + ']POW'
                }
            })
            $('.zelected').click()
        ...
        it('renderItem', function () {
            setup('with-two-options')
            $('#select').zelect({
                throttle: 0, renderItem: function (item) {
                    return $('<pre>').text(item.label)
                }
            })
        ...
        it('renderItem can e.g. highlight option matches', function () {
            ...
            $('#select').zelect({
                throttle: 0, renderItem: function (item, term) {
        ...
        it('regexpMatcher', function () {
            setup('with-two-options')
            $('#select').zelect({
                throttle: 0, regexpMatcher: function (term) {
        ...
        it('can zelectItem without firing a change event', function () {
            ...
            $('#select').on('change', function () {
                assert.fail(1, 2, 'No change event should fire')
            })
    ...
    describe('List navigation', function () {
        beforeEach(function () {
            setup('empty')
            $('#select').zelect({
                placeholder: 'Nothing selected', throttle: 0, loader: function (term, page, callback) {
