    ...
    <body>
        <table style="border: 1px solid white;  border-collapse: collapse; width: 100%;">
            <tr style="border: 1px solid white;  border-collapse: collapse; ">
                ...
                <td style="width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">{{ $DocID }}</td>
            </tr>
            <tr style="border: 1px solid white;  border-collapse: collapse;">
                <td style="width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">Дата: </td>
                <td style="width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">{{ $strDate }}</td>
            </tr>
        </table>
        <h1></h1>
        ...
        <div class="table-container">
            ...
            <table style="width: 100%;">
                <thead>
                    <tr>
                        <td style="border-bottom: 1px solid white; border-collapse: collapse; text-align: right; font-size: 12px; font-weight: bold;">Підприємство</td>
                        <td style="border-bottom: 1px solid white; border-collapse: collapse; text-align: left; font-size: 12px; font-weight: bold;">{{ $CompName }}</td>
                        <td style="border-bottom: 1px solid white; border-collapse: collapse; text-align: center; align-content: center; font-size: 12px; font-weight: bold;">{{ $CompID }}</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: right; font-size: 12px;">Адреса</td>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: center; font-size: 12px;">{{ $CompAdd }}</td>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: center; align-content: center; font-size: 12px;">72    1</td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: right; font-size: 12px;">Місто</td>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: left; font-size: 12px;">{{ $CityName }}</td>
                        <td style="border-bottom: 1px solid white; border-top: 1px solid white; border-collapse: collapse; text-align: center; align-content: center; font-size: 12px;">4</td>
                    </tr>
                    <tr>
                        <td style="border-top: 1px solid white; border-collapse: collapse; text-align: right; font-size: 12px;">Телефон:</td>
                        <td style="border-top: 1px solid white; border-collapse: collapse; text-align: left; font-size: 12px;">{{-- $CompContact --}}</td>
                        <td style="border-top: 1px solid white; border-collapse: collapse; text-align: center; align-content: center; font-size: 12px;">0</td>
                    </tr>
                </tfoot>
            </table>
            <br/>
            ...
            <table style="border: 1px solid white;  border-collapse: collapse; width: 100%;">
                <tr style="border: 1px solid white;  border-collapse: collapse; ">
                    <td style="width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">Кількість: {{ $TQty }}</td>
                    <td style="width: 65%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">Сума без ПДВ</td>
                    <td style="width: 15%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">{{ $TSum_nt }}</td>
                </tr>
                <tr style="border: 1px solid white;  border-collapse: collapse;">
                    <td style="width: 20%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">Загальна вага: {{ $TWeight }}</td>
                    <td style="width: 65%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">Сума ПДВ: </td>
                    <td style="width: 15%; font-size: 10px; font-weight: bold; border: 1px solid white;  border-collapse: collapse;">{{ $TQty }}</td>
                </tr>
            </table>
