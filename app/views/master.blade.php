...
<head>
    ...
    <link type="text/css" media="screen" rel="stylesheet"
          href="{{ url('public/packages/table/responsive-tables.css') }}"/>
    ...
    <link href="{{ url('public/packages/bootstrap-switch-master/dist/css/bootstrap3/bootstrap-switch.min.css') }}"
          rel="stylesheet">
    <script src="{{ url('public/packages/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}"
            type="text/javascript"></script>
    <script src="{{ url('public/packages/bootstrap-switch-master/dist/js/bootstrap-switch.min.js') }}"
            type="text/javascript"></script>
