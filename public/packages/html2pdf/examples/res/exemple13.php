...
<table style="border: solid 1px red; width: 105mm">
    <tr>
        <td style="width: 100%; border: solid 1px green; text-align: left; "><?php echo $phrase; ?></td>
    </tr>
    <tr>
        <td style="width: 100%; border: solid 1px green; text-align: center;"><?php echo $phrase; ?></td>
    </tr>
    <tr>
        <td style="width: 100%; border: solid 1px green; text-align: right; "><?php echo $phrase; ?></td>
    </tr>
</table>
<br>
Div :<br>
