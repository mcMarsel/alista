                    ...
                    <div class="modal-body">
                        <div class="table table-responsive"
                            ...
                            <div style="display: table-row-group;">
                                <div class="tr" style="display: table-row;">
                                    <div style="border: 1px solid black; display: table-cell;" class="td btn price-val"
                                    ...
                                    <div style="border: 1px solid black; display: table-cell; background-color: #ffff00"
                                         class="td btn price-val" id="p111" name="111"></div>
                                </div>
                            </div>
                        </div>
                        <input type="number" autocorrect="off" pattern="\d*" novalidate id="price-text"
