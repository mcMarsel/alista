...
<script src="{{ url('public/packages/manager/approved-orderT.js') }}" type="text/javascript"></script>
<br/>
	 <h1>Перед утверждением нужно заполнить данные о перевозчике</h1>
	{{ Form::open(['route'=>'approvedDoneT', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
