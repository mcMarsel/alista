    ...
    public function cat()
    {
        ...
        foreach($goods as $key => $value)
        {
            ...
            } else
            {
                ...
                if(count($value[1]) == 10)
                {
                    $html .= '<th hidden="hidden" class="p0" plid="'.$value[1][0]['PLID'].'" minpl="'.$value[1][0]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][0]['PriceMC'] * $currency))*/ceil(($value[1][0]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p1" plid="'.$value[1][1]['PLID'].'" minpl="'.$value[1][1]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][1]['PriceMC'] * $currency))*/ceil(($value[1][1]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p2" plid="'.$value[1][2]['PLID'].'" minpl="'.$value[1][2]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][2]['PriceMC'] * $currency))*/ceil(($value[1][2]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p3" plid="'.$value[1][3]['PLID'].'" minpl="'.$value[1][3]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][3]['PriceMC'] * $currency))*/ceil(($value[1][3]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p4" plid="'.$value[1][4]['PLID'].'" minpl="'.$value[1][4]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][4]['PriceMC'] * $currency))*/ceil(($value[1][4]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p5" plid="'.$value[1][5]['PLID'].'" minpl="'.$value[1][5]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][5]['PriceMC'] * $currency))*/ceil(($value[1][5]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p6" plid="'.$value[1][6]['PLID'].'" minpl="'.$value[1][6]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][6]['PriceMC'] * $currency))*/ceil(($value[1][6]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p7" plid="'.$value[1][7]['PLID'].'" minpl="'.$value[1][7]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][7]['PriceMC'] * $currency))*/ceil(($value[1][7]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p8" plid="'.$value[1][8]['PLID'].'" minpl="'.$value[1][8]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][8]['PriceMC'] * $currency))*/ceil(($value[1][8]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p9" plid="'.$value[1][9]['PLID'].'" minpl="'.$value[1][9]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][9]['PriceMC'] * $currency))*/ceil(($value[1][9]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    ...
                    $html .= '<th hidden="hidden" class="p8" plid="'.$value[1][8]['PLID'].'" minpl="'.$value[1][8]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][8]['PriceMC'] * $currency))*/ceil(($value[1][8]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p9" plid="'.$value[1][9]['PLID'].'" minpl="'.$value[1][9]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][9]['PriceMC'] * $currency))*/ceil(($value[1][9]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                    $html .= '<th hidden="hidden" class="p10" plid="'.$value[1][10]['PLID'].'" minpl="'.$value[1][10]['MinPLID'].'">'. /*sprintf("%.2f", ($value[1][10]['PriceMC'] * $currency))*/ceil(($value[1][10]['PriceMC'] * $currency / 6) * 100) / 100 * 6 .'</th>';
                }
