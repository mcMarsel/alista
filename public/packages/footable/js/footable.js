    ...
    F.Table = F.Class.extend(/** @lends FooTable.Table */{
        ...
        execute: function (reverse, enabled, methodName, param1, paramN) {
            ...
            var internal = self.components.internal.slice(0),
                core = enabled ? F.arr.get(self.components.core, function (c) {
                    return c.enabled;
                }) : self.components.core.slice(0),
                custom = enabled ? F.arr.get(self.components.custom, function (c) {
                    return c.enabled;
                }) : self.components.custom.slice(0);
        ...
        $create: function () {
            ...
            switch (self.position) {
                ...
                case 'right':
                    ...
                    break;
                default:
                    position = 'footable-paging-center';
                    break;
            }
