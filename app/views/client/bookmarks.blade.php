...
<div class="tab-content" >
    <div class="active tab-pane fade in" id="delivery_settings">
        <h1><small>Редактирование и добавление  адресов доставки и контактов</small></h1>
        <table class="table-striped table-responsive" id="tbAddress">
            @foreach($address as $key => $value)
                ...
                @endif
            @endforeach
            <tr><td>{{ Form::button('Добавить адрес', ['class' => 'btn-primary', 'id' => 'addAddress']) }}</td></tr>
        </table>
        <table class="table-striped table-responsive" id="tbContact">
            ...
            @endforeach
            <tr><td>{{ Form::button('Добавить контактное лицо', ['class' => 'btn-primary', 'id' => 'addContact']) }}</td></tr>
        </table>
    </div>
