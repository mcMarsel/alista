...
<page orientation="paysage" style="font-size: 18px">
    ...
    <div style="width: 70%; border: solid 1mm #770000; margin: 1mm; padding: 2mm; font-size: 4mm; line-height: normal; text-align: justify">
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum, nibh eu ultricies scelerisque, est lorem
        dignissim elit, quis tempus tortor eros non ipsum. Mauris convallis augue ac sapien. In scelerisque dignissim
        elit. Donec consequat semper lectus. Sed in quam. Nunc molestie hendrerit ipsum. Curabitur elit risus, rhoncus
        ut, mattis a, convallis eu, neque. Morbi luctus est sit amet nunc. In nisl. Donec magna libero, aliquet eu,
    ...
    <fieldset
            style="width: 70%; border: solid 1mm #770000; margin: 1mm; padding: 2mm; padding-top: 0mm; font-size: 4mm; line-height: normal; background: #FFFFFF;">
        <legend style=" background: #FFFFFF; padding: 1; border: solid 1px #440000;">Ceci est un exemple de fieldset
        </legend>
        <img src="./res/logo.gif" alt="logo html2pdf" style="float: left; width: 60mm; margin: 2mm; ">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum, nibh eu ultricies scelerisque, est lorem
        dignissim elit, quis tempus tortor eros non ipsum. Mauris convallis augue ac sapien. In scelerisque dignissim
...
<page orientation="portrait" format="150x200" style="font-size: 18px">
    ...
    <div class="special">
        <table>
            <tr>
                <td colspan="2" class="topLeftRight"
                    style="width: 100%; text-align:left;border-bottom:1px dashed #000000">blabla blabla
                </td>
            </tr>
            <tr>
                <td class="bottomLeft" style="width:70%;border-right:1px dashed #000000;text-align:left;">blabla
                    blabla
                </td>
                <td class="bottomRight" style="width: 30%; text-align:left;vertical-align:top;">Date :<br/> Signature :
                </td>
            </tr>
        </table>
    </div>
