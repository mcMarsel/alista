...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table table-responsive"
                         style="margin: 0 auto; text-align: center; border: 1px solid black; border-collapse: collapse; display: table;">
                        <div style="display: table-header-group;">
                            <div class="tr" style="display: table-row;">
                                ...
                                <div style="border: 1px solid black; display: table-cell; background-color: #ffff00"
                                     class="td">111
                                </div>
                            </div>
                        </div>
                        <div style="display: table-row-group;">
                            <div class="tr" id="value" style="display: table-row;">
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p101" name="101"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p102" name="102"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p103" name="103"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p104" name="104"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p105" name="105"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p106" name="106"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p107" name="107"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p108" name="108"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p109" name="109"></div>
                                <div style="border: 1px solid black; display: table-cell;" class="btn price-val"
                                     id="p110" name="110"></div>
                                <div style="border: 1px solid black; display: table-cell; background-color: #ffff00"
                                     class="btn price-val" id="p111" name="111"></div>
                            </div>
                        </div>
                    </div>
                    <input type="number" autocorrect="off" pattern="\d*" novalidate id="price-text" class="form-control"
                           placeholder="Введите цену">
                </div>
                <div class="modal-footer">
                    <button type="button" onclick="CloseModal()" class="btn btn-default" data-dismiss="modal">Закрыть
                    </button>
                    <button type="button" onclick="CloseModal()" class="btn btn-default" data-dismiss="modal"
                            id="modal-done">Готово
                    </button>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <a href="manager"
           id="a-createOrder">{{ Form::button('Новый счет',['id' => 'createOrder','class' => 'form-control  btn btn-primary btn-lg',  'style' => 'display: none; width: 100%;']) }}</a>
        <br/>
        <br/>
        <br/>
